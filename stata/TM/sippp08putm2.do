...
**  This program reads the 2008 SIPP Wave 2 Topical Module Data File 
**  Note:  This program is distributed under the GNU GPL. See end of
**  this file and http://www.gnu.org/licenses/ for details.
**  by Jean Roth Thu Nov  4 13:30:35 EDT 2010
**  Please report errors to jroth@nber.org
**  run with do sippp08putm2
...
local dct_name "sippp08putm2.dct"

** The line below does NOT need to be changed 

quietly infile using "${read_dir}`dct_name'", using("${read_dir}p08putm2.dat") clear
...
keep id rot wave ssuid eentaid epppnum erbamth erbatamt erbattyp erebate erebatoc erelat*

gen month = erbamth
saveold "${save_dir}sippp08putm2.dta" , replace
