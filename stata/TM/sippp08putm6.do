cd ~/Dropbox/MPCwhose
log using sippp08putm6.log, replace

**------------------------------------------------;

**  This program reads the 2008 SIPP Wave 6 Topical Module Data File 
**  Note:  This program is distributed under the GNU GPL. See end of
**  this file and http://www.gnu.org/licenses/ for details.
**  by Jean Roth Wed Jan 30 15:55:35 EST 2013
**  Please report errors to jroth@nber.org
**  run with do sippp08putm6
...
local dct_name "sippp08putm6.dct"


local dat_name "${read_dir}p08putm6.dat"
...
keep id rot wave ssuid eentaid epppnum eabmeet-aafday


saveold ${save_dir}sippp08putm6.dta , replace
